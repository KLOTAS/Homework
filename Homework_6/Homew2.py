...
if __name__ == '__main__':
    write_order_to_json('Марк Лутц – Изучаем Python', '1', '700', 'Егор', '22.10.2022')
    write_order_to_json('Р. Митчелл. Скрапинг веб-сайтов с помощью Python', '1', '500', 'Егор', '22.10.2022')